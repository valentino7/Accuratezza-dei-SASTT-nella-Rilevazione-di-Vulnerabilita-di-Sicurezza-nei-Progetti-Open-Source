...
def main():
    ...
    for elem in eam_dir:
        ...
        # ['CWE-113$core/src/main/java/io/undertow/server/protocol/http/HttpResponseConduit.java$writeString$85d4478e598105fe94ac152d3e11e388374e8b8$false','PROJECT NAME', '11', '0.0', 'no']
        ...
        for line in file_eam:
            ...
            try:
                os.mkdir("eam_java_files\\"+ badness + "\\" + cwe_id)
            except :
                print("creato")

            try:
                # Modificare il path utilizzando la cartelle contenente i file dei progetti
                shutil.copyfile("F:\\Valentino\\Progetti_da_buildare_2\\"+project_name+commit+"\\"+ path_file_java, "eam_java_files\\"+badness+"\\"+cwe_id+ "\\" +nome_file)
            except:
                print("_-------------------------------------_")
